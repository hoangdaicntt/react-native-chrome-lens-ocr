...
// Proto buffers generated by the original project, loaded via CommonJS modules emitted as `.cjs`.
// NodeNext module resolution allows default-importing these files while Metro bundles them for React Native.
import lensOverlayServerProto from './utils/proto_generated/lens_overlay_server_pb.cjs';
import lensOverlayClientContextProto from './utils/proto_generated/lens_overlay_client_context_pb.cjs';
import lensOverlayClientPlatformProto from './utils/proto_generated/lens_overlay_client_platform_pb.cjs';
import lensOverlayImageDataProto from './utils/proto_generated/lens_overlay_image_data_pb.cjs';
import lensOverlayRequestIdProto from './utils/proto_generated/lens_overlay_request_id_pb.cjs';
import lensOverlayFiltersProto from './utils/proto_generated/lens_overlay_filters_pb.cjs';
import lensOverlayGeometryProto from './utils/proto_generated/lens_overlay_geometry_pb.cjs';
...
const {
    ...
    LensOverlayServerErrorErrorType
} = lensOverlayServerProto;
const { LensOverlayClientContext, LocaleContext } = lensOverlayClientContextProto;
const { Platform, Surface } = lensOverlayClientPlatformProto;
const { ImageData, ImagePayload, ImageMetadata } = lensOverlayImageDataProto;
const { LensOverlayRequestId } = lensOverlayRequestIdProto;
const { AppliedFilter, AppliedFilters, LensOverlayFilterType } = lensOverlayFiltersProto;
const { CoordinateType } = lensOverlayGeometryProto;
...
export default class LensCore {
    ...
    #setCookies(combinedCookieHeader: string | string[] | null): void {
        // Cookie parsing is disabled on React Native builds to avoid dependency on `set-cookie-parser`.
        // Responses are processed without persisting Set-Cookie headers.
    }
